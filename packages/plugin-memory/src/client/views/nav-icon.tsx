 ...
 * 所以只能按标签文本认行。
 *
 * 做法与本机已有的 dsh-skill-hub 一致：作用域 DOM 补丁，把「记忆」那一行的齿轮换成
 * 我们选定的官方图标，并在设置面板重渲染后补回去。替换时继承外壳原有的 className，
 * 尺寸与颜色（currentColor）仍由外壳的 .navIcon 控制，所以跟随主题。
 *
...
const MARKER = 'data-dsh-memory-nav-icon'
 ...
 */
export function installMemoryNavIcon(): () => void {
