 ...
 * - BackfillNotice：首次聚合后的一次性可关闭提示条（弹窗顶部）
...
export function BackfillNotice(props: {
  ...
  return (
    <div className="ub-notice" data-dsh-usage-billing data-dsh-ub-notice data-kind="info" role="status">
      <span>
 ...
 * 看起来像事实的假日期（ledger 已有此 ruling；弹窗的提示条同样按 `> 0` 门控）。
 *
...
export function BackfillLedgerNote(props: { installAt: number | null; snapshotId: string }): JSX.Element {
  ...
  return (
    <p className="ub-sub" data-dsh-usage-billing data-dsh-ub-sub>
